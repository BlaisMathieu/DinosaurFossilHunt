...
public class StegosaurPopulator extends BlockPopulator {

    private int SpawnChance = 30000000;

    public StegosaurPopulator() {}

    public void generate(Block block) {
        Location loc = block.getLocation();
        try {
            SchematicLoading schem = new SchematicLoading("C:\\Users\\Mathieu\\Desktop\\serv\\plugins\\WorldEdit\\schematics\\GOODstego.schem");
            ...
            Bukkit.broadcastMessage("Nouveau fossile de stegosaur : " + loc.getX() + "   " + loc.getZ());
            ...
            for (int y = 1; y < 70; y++) {
                for (int z = 0; z < 16; z++) {
                    ...
                    if (r == 3 && block.getType().compareTo(Material.STONE) == 0) {
                        if ((block.getBiome().equals(Biome.FOREST) || block.getBiome().equals(Biome.BIRCH_FOREST)
                        ...
                        else if (block.getBiome().equals(Biome.SWAMP) || block.getBiome().equals(Biome.SWAMP_HILLS)) {
