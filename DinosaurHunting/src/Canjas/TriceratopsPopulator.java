...
public class TriceratopsPopulator extends BlockPopulator {

    private int SpawnChance = 30000000;

    public TriceratopsPopulator() {}

    public void generate(Block block) {
        Location loc = block.getLocation();
        try {
            SchematicLoading schem = new SchematicLoading("C:\\Users\\Mathieu\\Desktop\\serv\\plugins\\WorldEdit\\schematics\\GOODtrice.schem");
            ...
            Bukkit.broadcastMessage("Nouveau fossile de triceratops : " + loc.getX() + "   " + loc.getZ());
            ...
            for (int y = 1; y < 70; y++) {
                for (int z = 0; z < 16; z++) {
                    ...
                    if (r == 3 && block.getType().compareTo(Material.STONE) == 0) {
                        if (block.getBiome().equals(Biome.DARK_FOREST) || block.getBiome().equals(Biome.DARK_FOREST_HILLS))
                            generate(block);
                            ...
                            if (t == 1 && block.getType().compareTo(Material.STONE) == 0)
                                ...
                                || block.getBiome().equals(Biome.TALL_BIRCH_FOREST) || block.getBiome().equals(Biome.SNOWY_TUNDRA))) {
