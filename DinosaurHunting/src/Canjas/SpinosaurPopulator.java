...
public class SpinosaurPopulator extends BlockPopulator {

    private int SpawnChance = 30000000;

    public SpinosaurPopulator() {}

    public void generate(Block block) {
        Location loc = block.getLocation();
        try {
            SchematicLoading schem = new SchematicLoading("C:\\Users\\Mathieu\\Desktop\\serv\\plugins\\WorldEdit\\schematics\\GOODspino.schem");
            ...
            Bukkit.broadcastMessage("Nouveau fossile de spinosaur : " + loc.getX() + "   " + loc.getZ());
            ...
            for (int y = 1; y < 70; y++) {
                for (int z = 0; z < 16; z++) {
                    ...
                    if (r == 3 && block.getType().compareTo(Material.STONE) == 0) {
                        if (block.getBiome().equals(Biome.JUNGLE) || block.getBiome().equals(Biome.MODIFIED_JUNGLE)
